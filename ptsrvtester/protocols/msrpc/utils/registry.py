...
MSRPC_TESTS: dict[str, dict[str, object]] = {
    ...
    "ENUMPIPES": {
        "description": "Open selected common SMB named pipes (no RPC interface bind)",
        "family": "smb",
        "order": 30,
    },
    "ANONSMB": {
    ...
    "SAMRGROUPS": {
        "description": "Enumerate SAM groups, aliases and direct members",
        "family": "smb",
        "order": 47,
        "explicit_only": True,
        "credential_mode": "direct_required",
    ...
    "SAMRUSERINFO": {
        "description": "Read available SAM account timestamps and logon statistics",
        "family": "smb",
        "order": 48,
        "explicit_only": True,
        "credential_mode": "direct_required",
    ...
    "BRUTEPIPE": {
        "description": "Test SMB credentials and open one named pipe (no RPC method call)",
        "family": "smb",
        "order": 50,
        "explicit_only": True,
    ...
    "BRUTETCP": {
        "description": "Confirm RPC/TCP credentials with a supported read-only call",
        "family": "rpc",
        "order": 70,
        "explicit_only": True,
        "credential_mode": "product_required",
    ...
    "BRUTEHTTP": {
        "description": "Test RPC Proxy access and confirm an RPC backend read-only call",
        "family": "http",
        "order": 80,
        "explicit_only": True,
        "credential_mode": "product_required",
