...
class ContentMixin:
    ...
    def _get_antivirus_definitions_path(self) -> Path:
        ...
        # parents[1] = protocols/smtp (this file is protocols/smtp/tests/content.py)
        return Path(__file__).resolve().parents[1] / "utils" / "payloads" / "smtp" / "antivirus"
    ...
    def _get_ssrf_definitions_path(self) -> Path:
        ...
        # parents[1] = protocols/smtp (this file is protocols/smtp/tests/content.py)
        return Path(__file__).resolve().parents[1] / "utils" / "payloads" / "smtp" / "ssrf"
    ...
    def _get_zipxxe_definitions_path(self) -> Path:
        ...
        # parents[1] = protocols/smtp (this file is protocols/smtp/tests/content.py)
        return Path(__file__).resolve().parents[1] / "utils" / "payloads" / "smtp" / "zipxxe"
