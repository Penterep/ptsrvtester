...
# IMAP-style NOOP1/NOOP2 (duration + connection count). Defaults match IMAP.
SMTP_NOOP_PREAUTH_DUR_TEST_SECONDS = 35 * 60
SMTP_NOOP_PREAUTH_DUR_INTERVAL_SECONDS = 4 * 60
SMTP_NOOP_PREAUTH_DUR_TIMEOUT_SECONDS = 30
SMTP_NOOP_PREAUTH_DUR_INCREASED_MIN = 5 * 60
SMTP_NOOP_PREAUTH_DUR_SIGNIFICANT_MIN = 10 * 60
SMTP_NOOP_PREAUTH_DUR_HIGH_MIN = 30 * 60
...
NOOP1_RT_WINDOW = 10
NOOP1_PROGRESS_EVERY = 25

SMTP_NOOP_PREAUTH_CONN_TEST_SECONDS = 120
SMTP_NOOP_PREAUTH_CONN_INTERVAL_SECONDS = 60
SMTP_NOOP_PREAUTH_CONN_TIMEOUT_SECONDS = 30
SMTP_NOOP_PREAUTH_CONN_MAX_ATTEMPTS = 150
NOOP2_DEFAULT_CONNECTIONS = SMTP_NOOP_PREAUTH_CONN_MAX_ATTEMPTS

SMTP_NOOP_POSTAUTH_DUR_TEST_SECONDS = 130 * 60
SMTP_NOOP_POSTAUTH_DUR_INTERVAL_SECONDS = 20 * 60
SMTP_NOOP_POSTAUTH_DUR_TIMEOUT_SECONDS = 30
SMTP_NOOP_POSTAUTH_DUR_INCREASED_MIN = 60 * 60
SMTP_NOOP_POSTAUTH_DUR_SIGNIFICANT_MIN = 120 * 60
SMTP_NOOP_POSTAUTH_DUR_HIGH_MIN = 180 * 60

SMTP_NOOP_POSTAUTH_CONN_TEST_SECONDS = 180
SMTP_NOOP_POSTAUTH_CONN_INTERVAL_SECONDS = 60
SMTP_NOOP_POSTAUTH_CONN_TIMEOUT_SECONDS = 30
SMTP_NOOP_POSTAUTH_CONN_MAX_ATTEMPTS = 600
...
class NoopConnectionCountResult(NamedTuple):
    ...
    authenticated: bool
    max_connections_attempted: int
    connections_established: int
    connections_maintained: int
    test_duration_seconds: float
    total_noops_sent: int
    total_noops_ok: int
    total_noops_error: int
    early_disconnect_count: int
    error_message: str | None
...
class InfoResult(NamedTuple):
    ...
    ehlo_starttls_error: str | None = None  # Why live STARTTLS EHLO is missing (timeout / refused)
...
class EncryptionResult(NamedTuple):
    ...
    starttls_incomplete: bool = False
...
AUTH_ENUM_TIMEOUT_SIG = "\x00TIMEOUT"
...
class VULNS(Enum):
    ...
    NoopDurationPreauth = "PTV-SVC-SMTP-NOOPLIMDUR-PREAUTH"
    NoopDurationPostauth = "PTV-SVC-SMTP-NOOPLIMDUR-POSTAUTH"
    NoopConnCountPreauth = "PTV-SVC-SMTP-NOOPLIMCONN-PREAUTH"
    NoopConnCountPostauth = "PTV-SVC-SMTP-NOOPLIMCONN-POSTAUTH"
